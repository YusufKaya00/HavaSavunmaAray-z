	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				// ⚡ Bolt: Move accessors and buffers outside the loop to prevent Large Object Heap fragmentation and GC pressure.
				...
				{
					// ⚡ Bolt: Pre-allocate buffers for high-frequency reuse
