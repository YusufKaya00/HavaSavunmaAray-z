	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				// ⚡ BOLT OPTIMIZATION: Move accessor creation and buffer allocation outside the high-frequency loop.
				// This avoids creating and destroying ~1.2MB byte arrays and Accessor instances per frame,
				// vastly reducing GC pressure and preventing LOH fragmentation.
