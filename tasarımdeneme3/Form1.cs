	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// ⚡ Bolt Optimization: Pre-allocate large byte arrays (~1.2MB each) and ViewAccessors outside the
					// high-frequency loop to prevent severe Large Object Heap (LOH) fragmentation and GC pressure.
