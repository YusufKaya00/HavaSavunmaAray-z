...
namespace tasarımdeneme3
{
	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				// Bolt: Optimize memory usage by allocating the buffers exactly once outside the loop
				// thereby eliminating significant GC pressure from allocating ~1.2MB byte arrays 60 times/sec.
