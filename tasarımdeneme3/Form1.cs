	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// ⚡ Bolt: Pre-allocate large buffers and ViewAccessors outside the tight loop
					// to avoid massive Garbage Collection pressure and LOH (Large Object Heap) fragmentation.
