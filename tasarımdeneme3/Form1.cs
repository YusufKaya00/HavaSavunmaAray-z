	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				// ⚡ BOLT OPTIMIZATION: Pre-allocate Large Object Heap (LOH) arrays and Accessors outside the high-frequency loop
				// This prevents massive GC pressure from allocating ~1.2MB per frame (~60fps) x2, avoiding LOH fragmentation.
