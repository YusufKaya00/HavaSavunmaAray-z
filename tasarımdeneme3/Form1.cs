	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				// ⚡ BOLT OPTIMIZATION: Pre-allocate Large Object Heap (LOH) buffers and accessors outside the loop.
				// This prevents ~2.4MB of garbage per frame (144MB/sec at 60fps), eliminating GC pressure and frame drops.
				...
				{
					// Pre-allocate buffers for uncompressed 640x640x3 frames (1,228,800 bytes each)
