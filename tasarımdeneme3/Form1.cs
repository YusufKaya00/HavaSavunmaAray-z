	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// ⚡ Bolt Optimization: Pre-allocate buffers and accessors outside the high-frequency loop
					// to eliminate massive (~150MB/sec) Garbage Collection pressure and handle recreation overhead.
