	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Bolt Optimization: Pre-allocate large buffers and accessors outside the while loop
					// to avoid massive Garbage Collection (GC) pressure and Large Object Heap (LOH) fragmentation
					// caused by creating ~2.4MB of arrays every frame (60fps).
