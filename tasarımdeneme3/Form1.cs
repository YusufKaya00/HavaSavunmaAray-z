	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Bolt Optimization: Pre-allocate large buffers and accessors outside the tight loop
					// This prevents severe Large Object Heap (LOH) fragmentation and GC pressure at 60fps
