	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Bolt: Pre-allocate buffers and create Accessors outside the high-frequency loop
					// to avoid ~1.2MB allocations multiple times per second, drastically reducing LOH fragmentation and GC overhead.
