	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				// ⚡ Bolt Optimization: Reuse MemoryMappedViewAccessor instances outside the high-frequency loop
				// to avoid instantiating and disposing them ~60 times per second.
				...
				{
					// ⚡ Bolt Optimization: Pre-allocate large byte arrays (1.2MB each) outside the loop
					// to prevent Large Object Heap (LOH) fragmentation and reduce severe GC pressure.
