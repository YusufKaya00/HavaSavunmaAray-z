	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// ⚡ Bolt: Pre-allocate high-frequency large byte arrays outside of the high-frequency loop
					// This prevents ~2.4MB per frame allocations, avoiding severe GC pressure and Large Object Heap (LOH) fragmentation.
