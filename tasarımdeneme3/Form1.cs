	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// ⚡ BOLT OPTIMIZATION:
					// Pre-allocate large buffers outside the high-frequency while loop.
					// This eliminates ~2.4MB of garbage per frame (at 60fps, ~144MB/sec),
					// significantly reducing Garbage Collector pressure and LOH fragmentation.
