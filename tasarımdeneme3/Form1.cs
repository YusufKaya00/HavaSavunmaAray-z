	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Bolt Optimization: Pre-allocate large buffers and accessors outside the loop.
					// Avoids GC pressure and LOH fragmentation by reusing large arrays instead of creating ~1.2MB objects per frame.
