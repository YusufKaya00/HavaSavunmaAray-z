	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// ⚡ Bolt Optimization: Pre-allocate large buffers outside the high-frequency loop
					// This prevents severe Large Object Heap (LOH) fragmentation and Garbage Collection pressure
					// Since each frame is approx 1.2MB, allocating these inside the loop at 60fps causes massive GC overhead
