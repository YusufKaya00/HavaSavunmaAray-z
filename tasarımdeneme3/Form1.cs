	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Bolt Optimization: Pre-allocate buffers and accessors outside loop to avoid LOH fragmentation
					int frameSize = FrameWidth * FrameHeight * 3;
					byte[] rawBuffer = new byte[frameSize];
					byte[] processedBuffer = new byte[frameSize];
