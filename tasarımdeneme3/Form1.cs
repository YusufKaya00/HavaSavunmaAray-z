	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Bolt: Pre-allocate buffers and accessors outside the tight loop to prevent massive GC pressure
					// and Large Object Heap (LOH) fragmentation, since these arrays are approx 1.2MB each.
