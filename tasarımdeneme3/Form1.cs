	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Bolt Performance: Pre-allocate large buffers outside the high-frequency loop
					// This prevents continuous LOH (Large Object Heap) allocations and severe GC pressure
