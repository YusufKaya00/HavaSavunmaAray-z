	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// ⚡ Bolt: Hoist buffer allocation and MemoryMappedViewAccessor creation outside of the high-frequency loop
					// to prevent severe Large Object Heap (LOH) fragmentation and GC pauses from ~60fps 1.2MB byte array allocations.
