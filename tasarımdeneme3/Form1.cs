	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Optimize shared memory frame buffer allocation: Move allocations outside the high-frequency loop
					// This prevents allocating ~1.2MB byte arrays on every frame (~60fps), saving LOH fragmentation and GC pressure.
