	...
	private void ClockTimer_Tick(object sender, EventArgs e)
		...
		private void ReadSharedMemory()
		{
			try
			{
				...
				{
					// Bolt ⚡: Optimize memory allocation by reusing byte arrays
					// These arrays are 1.2 MB each, allocating them in a while(true) loop creates
					// enormous garbage collection pressure (~160 MB/sec).
